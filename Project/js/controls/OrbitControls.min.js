  ...
  class o extends THREE.EventDispatcher {
    constructor(o, a) {
          ...
          return function (t, n) {
            ...
            if (i.object.isPerspectiveCamera) {
              ...
              (r *= Math.tan(((i.object.fov / 2) * Math.PI) / 180)),
                N((2 * t * r) / o.clientHeight, i.object.matrix),
                w((2 * n * r) / o.clientHeight, i.object.matrix);
            } else
      ...
      function U(e) {
        ...
        g.subVectors(f, T).multiplyScalar(i.panSpeed), M(g.x, g.y), T.copy(f);
      }
      function V(e) {
        const t = q(e),
          n = e.pageX - t.x,
          ...
          a = Math.sqrt(n * n + o * o);
        R.set(0, a),
          H.set(0, Math.pow(R.y / O.y, i.zoomSpeed)),
          j(H.y),
          O.copy(R);
      }
      function _(e) {
            ...
            ? (function (e) {
                switch ((W(e), c)) {
                  ...
                  case r.TOUCH_DOLLY_PAN:
                    if (!1 === i.enableZoom && !1 === i.enablePan) return;
                    !(function (e) {
                      i.enableZoom && V(e), i.enablePan && U(e);
                    })(e),
                      i.update();
                    break;
                  case r.TOUCH_DOLLY_ROTATE:
                    ...
                    !(function (e) {
                      i.enableZoom && V(e), i.enableRotate && I(e);
                    })(e),
                      i.update();
                    break;
                  default:
                  ...
                  case r.PAN:
                    ...
                    !(function (e) {
                      f.set(e.clientX, e.clientY),
                        g.subVectors(f, T).multiplyScalar(i.panSpeed),
                        M(g.x, g.y),
                        T.copy(f),
                        i.update();
                    })(e);
